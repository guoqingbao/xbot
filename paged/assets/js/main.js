...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (typingContainer) {
    ...
    var lines = [
      ...
      { text: '  xbot v0.1.7 · 26 providers · 12 tools · 18 skills', html: '  <span class="token-comment">xbot v0.1.7</span> · <span class="token-func">26</span> providers · <span class="token-func">12</span> tools · <span class="token-func">18</span> skills' },
      { text: '', html: '' },
